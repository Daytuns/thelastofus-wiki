...
const characters = [
  {
    name: 'JOEL MILLER',
    picture: new URL('../assets/characters/JoelMiller.webp', import.meta.url).href,
  ...
  {
    name: 'DYNE',
    picture: new URL('../assets/characters/Dina1.webp', import.meta.url).href,
  ...
  {
    name: 'ELLIE WILLIAMS',
    picture: new URL('../assets/characters/EllieWilliams.webp', import.meta.url).href,
  ...
  {
    name: 'ABBY ANDERSON',
    picture: new URL('../assets/characters/AbbyAndrson1.webp', import.meta.url).href,
  ...
  {
    name: 'TOMMY MILLER',
    picture: new URL('../assets/characters/Tommy.webp', import.meta.url).href,
  ...
  {
    name: 'ISAAC DIXON',
    picture: new URL('../assets/characters/IsaacDixon.webp', import.meta.url).href,
  ...
  {
    name: 'JESSE',
    picture: new URL('../assets/characters/Jesse1.webp', import.meta.url).href,
  ...
  },
  {
    ...
    picture: new URL('../assets/characters/Tess.webp', import.meta.url).href,
  ...
  {
    name: 'LEV',
    picture: new URL('../assets/characters/Lev.webp', import.meta.url).href,
  ...
  {
    name: 'BILL',
    picture: new URL('../assets/characters/Bill.webp', import.meta.url).href,
  ...
  {
    name: 'YARA',
    picture: new URL('../assets/characters/Yara.webp', import.meta.url).href,
  ...
  {
    name: 'OWEN MOORE',
    picture: new URL('../assets/characters/OwenMoore.webp', import.meta.url).href,
  ...
  {
    name: 'MARLENE',
    picture: new URL('../assets/characters/Marlene.webp', import.meta.url).href,
  ...
  {
    name: 'JERRY ANDERSON',
    picture: new URL('../assets/characters/JerryAnderson.webp', import.meta.url).href,
  ...
  <div class="main-container bg-black flex h-screen">
    ...
    <div class="left flex align-center w-1/2 relative h-full">
      ...
      <img
        ...
        class="object-contain max-h-3/4 absolute left-0 bottom-0 opacity-0 z-10"
        id="characterPic"
        loading="lazy"
      >
      <div class="opacity-0 character-description">
        <h1 v-if="selectedCharacter" class="text-white w-1/2 h-1/2 roboto absolute top-20 right-0 mr-10 z-0" v-html="selectedCharacter.name"></h1>
        <p v-if="selectedCharacter" class="text-[#7F7E7E] w-1/2 h-1/2 text-base roboto absolute top-30 right-0 mr-10 z-0" v-html="selectedCharacter.description"></p>
      </div>
    </div>
